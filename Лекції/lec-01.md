...
Відомий метод при застосуванні до даної задачі може виглядати наступним чином: будемо називати файли за шаблоном filename\_{version}, можливо з додаванням часу створення або зміни.
