# Лабораторна робота №16. Встановлення та налаштування клієнту СКВ Subversion
...
2. Завантажити та встановити на комп'ютер графічну оболонку TortoiseSVN. В разі необхідності перезавантажити комп'ютер.
   ...
   1. Обрати розрядність системи, та натиcнути на завантаження правильного завантажувача.
      ![TortoiseSVN](img/18-19.jpg)
   2. Запустити завантажувач `TortoiseSVN`.
      ![TortoiseSVN](img/18-20.jpg)
   3. Обрати кнопку _Next_.
      ![TortoiseSVN](img/18-21.jpg)
   4. Обрати місце завантаження програми кнопкою _Browse_.
      ![TortoiseSVN](img/18-22.jpg)
   5. Обрати пункт _Will be installed on local hard drive_ та натиснути _Next_.
      ![TortoiseSVN](img/18-23.jpg)
   6. Завантажити програму.
      ![TortoiseSVN](img/016-013.jpg)
   7. Натиснути кнопку _Finish_.
      ![TortoiseSVN](img/016-014.jpg)
